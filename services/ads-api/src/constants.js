...
export const PLACEMENT_SPECS = {
  FULL_SCREEN: { aspect: 9 / 4, minWidth: 2700, minHeight: 1200, label: 'full-screen (18×8″, 9:4)' },
  HALF_SCREEN: { aspect: 9 / 8, minWidth: 1350, minHeight: 1200, label: 'half-screen (9×8″, 9:8)' },
};
